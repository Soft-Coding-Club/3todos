...
export default function TodoApp({ userName, userImage }: Props) {
    ...
    <main className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            <h1 className="text-3xl font-bold text-zinc-900">오늘의 할일</h1>
            <p className="text-zinc-400 text-sm mt-1">딱 3개만. 더는 안 돼요.</p>
          </div>
